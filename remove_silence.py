...
def get_silence_segments(video_path, min_silence=0.2, threshold=-35):
    cmd = [
...
def remove_silence(input_path, output_path, min_silence=0.2, threshold=-35):
...
for f in sorted(source_dir.glob("*.MP4")):
    ...
    remove_silence(f, out, min_silence=0.2, threshold=-35)
